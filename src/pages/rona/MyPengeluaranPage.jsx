...
import { Wallet, Plus, X, Calendar, Tag, DollarSign, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="p-4 sm:p-6 ">
      ...
      <div className="grid grid-cols-3 gap-2 mb-6">
        {[
          { label: "Total bulan ini", value: "Rp 0", gradient: "from-emerald-500 to-emerald-400", icon: Wallet },
          { label: "Total hari ini", value: "Rp 0", gradient: "from-blue-500 to-blue-400", icon: Calendar },
          { label: "Rata-rata/hari", value: "Rp 0", gradient: "from-amber-500 to-amber-400", icon: TrendingUp },
        ].map((s, i) => (
          ...
          >
            <div className="p-5 bg-white rounded-2xl border border-zinc-100">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full py-2.5 rounded-xl bg-emerald-600 text-white text-xs font-semibold hover:bg-emerald-700 transition-all">
                  Simpan
                </button>
              </div>
            </div>
